...
public abstract class TopKRecommender {
	...
	//public ArrayList<ArrayList<Rating>> user_ratings;
	/** Position to cutoff. */
	public int topK = 100;
	 ...
	 */
	public double[] showProgress(int iter, long start, ArrayList<Rating> testRatings) throws IOException{
	 ...
	 */
	public void evaluateOnline(ArrayList<Rating> testRatings, int interval) throws IOException  {
		...
		PrintWriter writer = new PrintWriter (new FileOutputStream("online.progress"));
